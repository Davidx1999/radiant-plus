    ...
    `})),v,y,b,x=e((()=>{v={descricao:`Dados via Fetch de Telemetria, não visuais ao usuário`,visivel_ao_usuario:!1,campos:[{id:`variante`,label:`Variante`,entry:`entry.1532613467`,tipo:`single_choice`,opcoes:[`Dark`,`Radiant`]},{id:`tempo_cpu`,label:`Tempo CPU`,entry:`entry.1345222698`,tipo:`number`,unidade:`ms`},{id:`memoria_ram`,label:`Memória RAM`,entry:`entry.1504379310`,tipo:`number`,unidade:`MB consumida`},{id:`tempo_usuario`,label:`Tempo Usuário`,entry:`entry.778706530`,tipo:`number`,unidade:`segundos`},{id:`total_cliques`,label:`Total de Cliques`,entry:`entry.2138517373`,tipo:`integer`},{id:`cliques_errados`,label:`Cliques Errados`,entry:`entry.1179815513`,tipo:`integer`},{id:`abandono`,label:`Abandono`,entry:`entry.713314953`,tipo:`single_choice`,opcoes:[`Sim`,`Não`]},{id:`adesao_survey_radiant`,label:`Adesão ao Survey`,entry:`entry.1731007937`,tipo:`single_choice`,opcoes:[`Sim`,`Não`],condicao:{campo:`variante`,valor:`Radiant`}}]},y={titulo:`Formulário visível ao usuário`,visivel_ao_usuario:!0,secoes:[{id:`secao_1`,titulo:`Seção 1`,perguntas:[{id:`idade`,pergunta:`Qual a sua idade?`,entry:`entry.1676829727`,tipo:`number`},{id:`genero`,pergunta:`Com qual gênero você se identifica?`,entry:`entry.1247370759`,tipo:`single_choice`,opcoes:[`Feminino`,`Masculino`,`Não-binário ou Gênero Fluido`,`Prefiro não informar`,`Outros + input de resposta curta`]},{id:`escolaridade`,pergunta:`Qual o seu grau de escolaridade?`,entry:`entry.980747346`,tipo:`single_choice`,opcoes:[`Ensino Médio`,`Graduação`,`Pós-graduação`,`Mestrado`,`Doutorado`]},{id:`frequencia_servicos_digitais`,pergunta:`Com que frequência você utiliza serviços digitais no seu dia a dia?`,entry:`entry.800785701`,tipo:`single_choice`,opcoes:[`Raramente`,`Algumas vezes por semana`,`Diariamente`,`Quase o tempo todo`]},{id:`frequencia_streaming`,pergunta:`Com que frequência você utiliza plataformas de streaming, como Netflix, Amazon Prime ou HBO?`,entry:`entry.207727496`,tipo:`single_choice`,opcoes:[`Raramente`,`Algumas vezes na semana`,`Diariamente`]},{id:`area_atuacao`,pergunta:`Qual a sua área de atuação profissional?`,entry:`entry.92729514`,tipo:`single_choice`,opcoes:[`Tecnologia/TI`,`Outras Áreas`]}]},{id:`secao_2`,titulo:`Seção 2`,perguntas:[{id:`assinatura_mantida_ativa`,pergunta:`Notamos que, ao final da tarefa, a assinatura do serviço foi mantida ativa. Essa foi uma escolha intencional da sua parte?`,entry:`entry.190227893`,tipo:`single_choice`,opcoes:[`Sim, ao longo do processo eu mudei de ideia e decidi manter o serviço.`,`Não, eu queria cancelar, mas o processo foi muito confuso/cansativo e eu desisti.`,`Não, eu acreditei que havia concluído o cancelamento com sucesso.`,`- Não se Aplica - `],condicao:{campo:`abandono`,valor:`Não houve abandono`,observacao:`Campo condicional caso o usuário mantenha o serviço ou não conclua o cancelamento.`}}]},{id:`secao_3`,titulo:`Seção 3`,perguntas:[{id:`pu_1_frustracao`,pergunta:`Fiquei frustrado ao usar a funcionalidade de cancelamento do serviço de streaming.`,entry:`entry.1502601928`,tipo:`likert`,opcoes:[`Discordo Totalmente`,`Discordo`,`Neutro (Sem opinião formada)`,`Concordo`,`Concordo Totalmente`]},{id:`pu_2_confusao`,pergunta:`Achei a funcionalidade de cancelamento do serviço de streaming confusa de usar.`,entry:`entry.1902243391`,tipo:`likert`,opcoes:[`Discordo Totalmente`,`Discordo`,`Neutro (Sem opinião formada)`,`Concordo`,`Concordo Totalmente`]},{id:`pu_5_cansativo`,pergunta:`Foi muito cansativo usar a funcionalidade de cancelamento do serviço de streaming.`,entry:`entry.809311676`,tipo:`likert`,opcoes:[`Discordo Totalmente`,`Discordo`,`Neutro (Sem opinião formada)`,`Concordo`,`Concordo Totalmente`]},{id:`pu_7_controle`,pergunta:`Eu me senti no controle ao usar a funcionalidade de cancelamento do serviço de streaming.`,entry:`entry.623789119`,tipo:`likert`,opcoes:[`Discordo Totalmente`,`Discordo`,`Neutro (Sem opinião formada)`,`Concordo`,`Concordo Totalmente`]},{id:`rw_4_experiencia_gratificante`,pergunta:`Minha experiência foi gratificante.`,entry:`entry.1322165548`,tipo:`likert`,opcoes:[`Discordo Totalmente`,`Discordo`,`Neutro (Sem opinião formada)`,`Concordo`,`Concordo Totalmente`]},{id:`voltaria_utilizar_servico`,pergunta:`Você voltaria a utilizar este serviço de streaming futuramente?`,entry:`entry.1058417714`,tipo:`single_choice`,opcoes:[`Sim`,`Não`,`Talvez`]}]}]},b={telemetria:v,formulario:y}}));t((()=>{a(),s(),l(),d(),p(),h(),_(),x(),window.start_time_ms=0,window.end_time_ms=0,window.clics_errados=0,window.clics_totais=0,window.radiantSurveySelectValue=``,window.radiantSurveyTextareaValue=``,document.addEventListener(`click`,function(e){if(e.target.closest(`.ignorar-clique`))return;let t=e.target.closest(`button`)?e.target.closest(`button`).id:``,n=e.target.closest(`button`)?e.target.closest(`button`).textContent.toLowerCase():``;t===`btn-radiant-send-survey`||n.includes(`encerrar`)||n.includes(`enviar resposta`)||n.includes(`manter`)||n.includes(`finalizar`)||e.target.closest(`button, a, input, select, label, textarea`)&&window.start_time_ms>0&&window.end_time_ms===0&&window.app&&window.app.state.view!==`loading`&&(window.clics_totais++,console.log(`Clique válido registrado! Total:`,window.clics_totais))}),window.currentSectionIndex=0,window.visibleSections=[],window.userAnswers={},window.initSurvey=()=>{window.visibleSections=b.formulario.secoes.filter(e=>!e.perguntas.every(e=>{if(e.condicao){if(e.condicao.campo===`abandono`)return!window.app.state.abandonou;if(e.condicao.campo===`variante`)return(window.app.state.pattern===`radiant`?`Radiant`:`Dark`)!==e.condicao.valor}return!1})),window.currentSectionIndex=0;let e=document.getElementById(`form-main-title`);e&&(e.innerText=b.formulario.titulo),window.renderSection()},window.saveAnswer=(e,t)=>{window.userAnswers[e]=t},window.handleGeneroChange=e=>{let t=document.getElementById(`genero-outros-container`),n=document.getElementById(`genero-outros-input`);e.value===`Outros + input de resposta curta`?(t&&(t.style.display=`block`),n&&n.focus(),window.saveAnswer(`genero`,`Outros: ${n?n.value:``}`)):(t&&(t.style.display=`none`),window.saveAnswer(`genero`,e.value))},window.saveOutrosAnswer=e=>{window.saveAnswer(`genero`,`Outros: ${e}`)},window.handleAreaAtuacaoChange=e=>{let t=document.getElementById(`area-atuacao-outros-container`),n=document.getElementById(`area-atuacao-outros-input`);e.value===`Outras Áreas`?(t&&(t.style.display=`block`),n&&n.focus(),window.saveAnswer(`area_atuacao`,`Outras: ${n?n.value:``}`)):(t&&(t.style.display=`none`),window.saveAnswer(`area_atuacao`,e.value))},window.saveAreaAtuacaoOutrasAnswer=e=>{window.saveAnswer(`area_atuacao`,`Outras: ${e}`)},window.validateCurrentSection=()=>{let e=window.visibleSections[window.currentSectionIndex],t=!0;return e.perguntas.forEach(e=>{if(e.condicao&&(e.condicao.campo===`abandono`&&!window.app.state.abandonou||e.condicao.campo===`variante`&&(window.app.state.pattern===`radiant`?`Radiant`:`Dark`)!==e.condicao.valor))return;let n=window.userAnswers[e.id];if(e.tipo===`number`){let e=n?parseInt(n):0;(!e||e<18||e>120)&&(t=!1)}else e.id===`genero`?n?n.startsWith(`Outros:`)&&n.replace(`Outros:`,``).trim()===``&&(t=!1):t=!1:e.id===`area_atuacao`?n?n.startsWith(`Outras:`)&&n.replace(`Outras:`,``).trim()===``&&(t=!1):t=!1:n||(t=!1)}),t},window.surveyNextPage=()=>{let e=document.getElementById(`survey-validation-error`);if(e&&e.classList.add(`hidden`),!window.validateCurrentSection()){e&&e.classList.remove(`hidden`);return}window.currentSectionIndex<window.visibleSections.length-1&&(window.currentSectionIndex++,window.scrollTo({top:0,behavior:`smooth`}),window.renderSection())},window.surveyPrevPage=()=>{let e=document.getElementById(`survey-validation-error`);e&&e.classList.add(`hidden`),window.currentSectionIndex>0&&(window.currentSectionIndex--,window.scrollTo({top:0,behavior:`smooth`}),window.renderSection())},window.renderSection=()=>{let e=document.getElementById(`questions-container`);if(!e)return;e.innerHTML=``;let t=window.visibleSections[window.currentSectionIndex],n=document.getElementById(`section-title`);n&&(n.innerText=t.titulo||`Seção ${window.currentSectionIndex+1}`);let r=document.getElementById(`progress-container`);r&&r.classList.remove(`hidden`);let i=document.getElementById(`progress-bar`);if(i){let e=window.currentSectionIndex/window.visibleSections.length*100;i.style.width=`${e}%`}t.perguntas.forEach((t,n)=>{if(t.condicao&&(t.condicao.campo===`abandono`&&!window.app.state.abandonou||t.condicao.campo===`variante`&&(window.app.state.pattern===`radiant`?`Radiant`:`Dark`)!==t.condicao.valor))return;let r=document.createElement(`div`);r.className=`bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow text-left`,r.innerHTML=`<label class="block text-gray-900 font-semibold text-lg mb-4">${n+1}. ${t.pergunta}</label>`;let i=``;if(t.tipo===`number`){let e=window.userAnswers[t.id]||``;i=`<input type="number" id="${t.id}" class="w-full sm:w-1/2 p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors" placeholder="Digite um número..." value="${e}" onchange="window.saveAnswer('${t.id}', this.value)">`}else if(t.tipo===`single_choice`&&t.id!==`genero`&&t.id!==`area_atuacao`)i=`<div class="space-y-3">`,t.opcoes.forEach((e,n)=>{let r=window.userAnswers[t.id]===e?`checked`:``;i+=`
                ...
                `,o){let t=n?`block`:`none`,r=n?e.replace(`Outros: `,``):``;i+=`
                        <div id="genero-outros-container" style="display: ${t};" class="mt-2 pl-8">
                            <input type="text" id="genero-outros-input" class="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none" placeholder="Por favor, especifique" value="${r}" oninput="window.saveOutrosAnswer(this.value)">
                        </div>
                ...
                `,o){let t=n?`block`:`none`,r=n?e.replace(`Outras: `,``):``;i+=`
                        <div id="area-atuacao-outros-container" style="display: ${t};" class="mt-2 pl-8">
                            <input type="text" id="area-atuacao-outros-input" class="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none" placeholder="Por favor, especifique" value="${r}" oninput="window.saveAreaAtuacaoOutrasAnswer(this.value)">
                        </div>
            ...
            `,t.opcoes.forEach((e,n)=>{let r=window.userAnswers[t.id]===e?`checked`:``,a=`${t.id}_${n}`;i+=`
                ...
                `}),i+=`</div>`);r.innerHTML+=i,e.appendChild(r)});let a=document.getElementById(`btn-prev`),o=document.getElementById(`btn-next`),s=document.getElementById(`btn-submit`);a&&(a.style.display=window.currentSectionIndex>0?`block`:`none`),window.currentSectionIndex===window.visibleSections.length-1?(o&&(o.style.display=`none`),s&&(s.style.display=`block`)):(o&&(o.style.display=`block`),s&&(s.style.display=`none`))},window.enviarTelemetria=function(e=!1,t={}){let n=window.end_time_ms-window.start_time_ms,r=((performance.memory?performance.memory.usedJSHeapSize:0)/(1024*1024)).toFixed(2),i=(n/1e3).toFixed(2),a=`Radiant Plus`,o=window.radiantSurveySelectValue&&window.radiantSurveySelectValue!==``?`Sim`:`Não`,s=new URLSearchParams;s.append(`entry.1532613467`,a),s.append(`entry.1345222698`,n.toFixed(2)),s.append(`entry.1504379310`,r),s.append(`entry.778706530`,i),s.append(`entry.2138517373`,window.clics_totais),s.append(`entry.1179815513`,window.clics_errados),s.append(`entry.713314953`,e?`Sim`:`Não`),s.append(`entry.1731007937`,o),s.append(`entry.2122783098`,window.radiantSurveyTextareaValue||``),s.append(`entry.1676829727`,t.idade||``),t.genero===`Outros + input de resposta curta`?(s.append(`entry.1247370759`,`__other_option__`),s.append(`entry.1247370759.other_option_response`,t.genero_outro||``)):t.genero===`Não-binário ou Gênero Fluido`?s.append(`entry.1247370759`,`Não-binário / Gênero fluido`):t.genero===`Prefiro não informar`?s.append(`entry.1247370759`,`Prefiro Não Informar`):s.append(`entry.1247370759`,t.genero||``),s.append(`entry.980747346`,t.escolaridade||``),s.append(`entry.800785701`,t.freq_digital||``),t.freq_streaming===`Algumas vezes na semana`?s.append(`entry.207727496`,`Algumas vezes por semana`):s.append(`entry.207727496`,t.freq_streaming||``),t.area_atuacao===`Tecnologia/TI`?s.append(`entry.92729514`,`Tecnologia/TI`):(s.append(`entry.92729514`,`__other_option__`),s.append(`entry.92729514.other_option_response`,t.area_atuacao_outro||``));let c=e?t.assinatura_mantida||``:`-- Não houve abandono --`;(c===`- Não se Aplica - `||c===`- Não se Aplica -`||c===``)&&(c=`-- Não houve abandono --`),s.append(`entry.190227893`,c),s.append(`entry.1502601928`,t.pu_1||``),s.append(`entry.1902243391`,t.pu_2||``),s.append(`entry.809311676`,t.pu_5||``),s.append(`entry.623789119`,t.pu_7||``),s.append(`entry.1322165548`,t.rw_4||``),s.append(`entry.1058417714`,t.voltaria||``);let l=document.getElementById(`btn-submit`);l&&(l.disabled=!0,l.innerHTML=`Enviando...`),fetch(`https://docs.google.com/forms/d/e/1FAIpQLSew5wW0PPVcnijXjbyhStfCS9fuKorg4Q_00FVgPPtgVyzzPw/formResponse`,{method:`POST`,mode:`no-cors`,body:s}).then(()=>{l&&(l.disabled=!1,l.innerHTML=`Enviar Respostas ✓`);let t={};s.forEach((e,n)=>{t[n]=e});let c={Mapped_Data_For_Backend:t,Human_Readable_Telemetry:{variante:a,tempo_cpu:n,memoria_ram:r,tempo_usuario:i,total_cliques:window.clics_totais,cliques_errados:window.clics_errados,abandono:e?`Sim`:`Não`,respondeu_survey:o},Human_Readable_Answers:window.userAnswers},u=document.getElementById(`custom-modal`),d=document.getElementById(`modal-content`),f=document.getElementById(`modal-json-output`);f&&(f.textContent=JSON.stringify(c,null,2));let p=document.getElementById(`modal-telemetry-summary`);p&&(p.innerHTML=`
                    <ul class="space-y-1.5 leading-relaxed font-sans text-gray-700 text-left">
                        ...
                        <li><span class="opacity-60 font-medium">Abandonou a Aplicação:</span> <strong class="font-bold ${e?`text-red-500`:`text-blue-600`}">${e?`Sim`:`Não`}</strong></li>
